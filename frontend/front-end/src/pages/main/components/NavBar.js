            ...
            <Toolbar>
                <Grid container sx={{alignItems: 'center'}} flexGrow={2}>
                    ...
                    <Grid item xs={3} sm={4} md={6} lg={6} xl={6} sx={{}}>
                        <Stack direction="row" sx={{position:"absolute", right: {xs:"1em", sm:"1em", md:"1em", lg:"1em", xl:"1em"}, top:{xs:"0.6em", sm:"0.6em", md:"0.6em", lg:"0.6em", xl:"0.6em"} }} spacing={{xs:1, sm:2, md:3, lg:3, xl:3}}>
